      ...
      <div className="max-w-2xl sm:py-6 mx-auto">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          >
            ...
            <div>
              <label className="block text-sm font font-medium text-gray-700 mb-1">Name</label>
              <input
                type="text"
                className="w-full p-3 border border-gray-200 rounded-lg"
            ...
            <div>
              <label className="block text-sm font font-medium text-gray-700 mb-1">Username</label>
              <input
                type="text"
                className="w-full p-3 border border-gray-200 rounded-lg"
            ...
            <div>
              <label className="block text-sm font font-medium text-gray-700 mb-1">Bio</label>
              <textarea
                rows={3}
                type="text"
                className="w-full p-3 border border-gray-200 rounded-lg"
            ...
            <div>
              <label className="block text-sm font font-medium text-gray-700 mb-1">Location</label>
              <input
                type="text"
                className="w-full p-3 border border-gray-200 rounded-lg"
