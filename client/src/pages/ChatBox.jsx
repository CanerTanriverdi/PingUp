  ...
  return (
    user && (
      <div className="flex flex-col h-screen">
        <div className="flex items-center gap-2 p2 md:px-10 xl:pl-42 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-gray-300">
          <img
            src={user.profile_picture ? user.profile_picture : "https://ssl.gstatic.com/accounts/ui/avatar_2x.png"}
            alt=""
        ...
        <div className="px-4">
          <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
            ...
            <button
              onClick={sendMessage} // butona basinca calismasi icin eklendi
